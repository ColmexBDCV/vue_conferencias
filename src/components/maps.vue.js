...
export default{
    ...
    data() {
        return {
            ...
            map: null,
            url_api: 'https://repositorio.colmex.mx/all_coordinates?query=thematic_collection_tesim:%22RDDM%22&fields=id,title_tesim,has_model_ssim,thumbnail_path_ss,hasRelatedMediaFragment_ssim',
        }
    },
    watch:{
        api_data(){
